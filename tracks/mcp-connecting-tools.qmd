...
```{=html}
<details class="activity"><summary>Activity 3 · Advanced — Configure a real least-privilege MCP connection</summary>
```
...
1. Test that reading works. Ask a question answerable only from the practice files:
...
2. Test the boundary. Ask for something outside the folder and confirm it fails:
...
3. Now deliberately try to make it write:
