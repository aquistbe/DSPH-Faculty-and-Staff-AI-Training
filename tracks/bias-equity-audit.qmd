...
```{=html}
<details class="activity"><summary>Activity 3 · Moderate — Scale the audit across many demographic combinations with Claude Code</summary>
```
...
1. Open Claude Code in an empty folder and describe the batch job — validate on one before running all 10:
...
2. Inspect the single test output. Does it look like Activity 1's outputs? If yes, tell Claude Code to run the remaining nine.

3. Ask for the first-pass comparison:
...
4. Audit a sample: open 2-3 of the raw output files and verify the table's counts against them — don't trust the tabulation blindly.

5. Look down each column for demographic patterns: does compliance/substance language cluster in certain rows while clinical inputs were identical?
