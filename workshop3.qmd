...
::: {.slides-cta}
[📊 Open the slides ↗](slides/workshop3.html){.btn .btn-primary target="_blank" role="button"}
[⬇ Editable PowerPoint](slides/DSPH_Workshop3_Collaboration_on_Projects.pptx){.btn .btn-outline-primary role="button"}
:::

:::{.callout-note}
## Demo Files
No team materials on hand? Download a synthetic demo file (all content fictional and non-sensitive):
[Messy meeting notes (Word)](demo-materials/Workshop3_Demo_MeetingNotes.docx) ·
[Project description (Word)](demo-materials/Workshop3_Demo_ProjectDescription.docx) ·
[Team style guide (Word)](demo-materials/Workshop3_Demo_StyleGuide.docx) ·
[Update template (Word)](demo-materials/Workshop3_Demo_UpdateTemplate.docx)
:::
...
1. Paste messy meeting notes (real but non-sensitive, or use [Workshop3_Demo_MeetingNotes.docx](demo-materials/Workshop3_Demo_MeetingNotes.docx) --- a fictional study-team check-in --- or the short sample below) into ChatGPT Edu. Use **GPT-5.5** if it is available; otherwise use the current default/latest GPT model in the Drexel workspace.
2. Use this prompt:
...
1. Describe a project in a sentence or two (or paste the two-paragraph description from [Workshop3_Demo_ProjectDescription.docx](demo-materials/Workshop3_Demo_ProjectDescription.docx)) and ask:
