...
::: {.slides-cta}
[📊 Open the slides ↗](slides/workshop1.html){.btn .btn-primary target="_blank" role="button"}
[⬇ Editable PowerPoint](slides/DSPH_Workshop1_Foundations_and_Capabilities.pptx){.btn .btn-outline-primary role="button"}
:::
